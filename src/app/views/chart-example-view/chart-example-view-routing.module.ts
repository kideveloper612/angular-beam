...
import { marcoExampleViewerTemplateComponent } from 'app/shared/components/example-viewer-template/example-viewer-template.component';
...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: "",
        component: marcoExampleViewerTemplateComponent,
        data: {
